...
public class FileIOImp implements FileIO {
	...
	public String uploadProject(Part part,String filename) {
		...
		try {
			...
			is.read(b);
			String path ="C:\\Users\\Pranay\\eclipse-workspace\\MyPortfolio\\WebContent\\myproject\\"+filename;
	...
	public String uploadResume(Part part) {
		try {
			...
			path = "C:\\Users\\Pranay\\eclipse-workspace\\MyPortfolio\\WebContent\\MyResume\\";
			...
			byte b[] = new byte[is.available()];
			is.read(b);
			path = "C:\\Users\\Pranay\\eclipse-workspace\\MyPortfolio\\WebContent\\MyResume\\"+filename;              
			FileOutputStream fos = new FileOutputStream(path);
			fos.write(b);
			fos.close();
			status = "uploaded";
